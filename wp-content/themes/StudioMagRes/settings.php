...
<tr>
  ...
  <td><textarea name="home_featured_text" style="width: 550px; height: 150px;"><?php echo stripslashes(stripslashes(get_option($shortname.'_home_featured_text',''))); ?></textarea></td>
</tr>
<tr>
  <td>Facebook Link:</td>
